import type {
  ...
  HairStyle, Attribute, Personality, LocationId, Floor
} from './types';
...
function makeHobbies(
  ...
  const all: HobbyTopic[] = ['love', 'game', 'sns', 'sports', 'study', 'video', 'music', 'reading', 'fashion', 'fortune'];
...
export const STUDENTS: Student[] = [
  ...
  },
  {
    ...
    hobbies: makeHobbies(['sns', 'fashion', 'fortune'], ['sports', 'study']),
    revealedHobbies: new Set<HobbyTopic>(),
  ...
  },
  {
    ...
    personality: 'cautious' as Personality,
    hobbies: makeHobbies(['reading', 'sns', 'fortune'], ['sports']),
    revealedHobbies: new Set<HobbyTopic>(),
  ...
  // 1-A サブリーダー
  {
    ...
    attributes: ['airhead', 'young'] as Attribute[],
    likedAttributes: ['fashionable', 'cool'] as Attribute[],
    dislikedAttributes: ['delinquent', 'sporty'] as Attribute[],
  ...
  // 1-A メンバー
  {
    ...
    attributes: ['fashionable', 'young', 'energetic_social'] as Attribute[],
    likedAttributes: ['fashionable', 'energetic_social'] as Attribute[],
    dislikedAttributes: ['serious', 'introverted'] as Attribute[],
  ...
  // 1-B サブリーダー
  {
    ...
    hairStyle: 'straight' as HairStyle,
    personality: 'passionate' as Personality,
    hobbies: makeHobbies(['sports', 'video'], ['study', 'reading']),
    revealedHobbies: new Set<HobbyTopic>(),
    support: { conservative: 15, progressive: 25, sports: 60 },
  ...
  // 1-C サブリーダー
  {
    ...
    hairStyle: 'straight' as HairStyle,
    personality: 'cautious' as Personality,
    hobbies: makeHobbies(['reading', 'study'], ['sports', 'fashion']),
    revealedHobbies: new Set<HobbyTopic>(),
  ...
  // 1-C メンバー
  {
    ...
    personality: 'flexible' as Personality,
    hobbies: makeHobbies(['music', 'fashion'], ['sports']),
    revealedHobbies: new Set<HobbyTopic>(),
    support: { conservative: 30, progressive: 45, sports: 25 },
    attributes: ['introverted', 'young'] as Attribute[],
    likedAttributes: ['cool', 'fashionable'] as Attribute[],
    dislikedAttributes: ['sporty', 'delinquent'] as Attribute[],
  ...
  // 1-D サブリーダー
  {
    ...
    hairStyle: 'straight' as HairStyle,
    personality: 'stubborn' as Personality,
    hobbies: makeHobbies(['sports', 'game'], ['fashion', 'love']),
    revealedHobbies: new Set<HobbyTopic>(),
    support: { conservative: 30, progressive: 15, sports: 55 },
    attributes: ['sporty', 'serious'] as Attribute[],
    likedAttributes: ['sporty', 'serious'] as Attribute[],
    dislikedAttributes: ['airhead', 'fashionable'] as Attribute[],
  ...
  // 1-D メンバー
  {
    ...
    hairStyle: 'straight' as HairStyle,
    personality: 'cautious' as Personality,
    hobbies: makeHobbies(['game', 'video'], ['sports']),
    revealedHobbies: new Set<HobbyTopic>(),
    support: { conservative: 35, progressive: 45, sports: 20 },
    attributes: ['introverted', 'glasses'] as Attribute[],
    likedAttributes: ['introverted', 'glasses'] as Attribute[],
    dislikedAttributes: ['energetic_social', 'sporty'] as Attribute[],
  ...
  // 2-A サブリーダー
  {
    ...
    hairStyle: 'ponytail' as HairStyle,
    personality: 'cunning' as Personality,
    hobbies: makeHobbies(['sports', 'sns'], ['reading']),
    revealedHobbies: new Set<HobbyTopic>(),
    support: { conservative: 20, progressive: 40, sports: 40 },
    attributes: ['sporty', 'fashionable', 'energetic'] as Attribute[],
    likedAttributes: ['sporty', 'fashionable'] as Attribute[],
    dislikedAttributes: ['introverted', 'airhead'] as Attribute[],
  ...
  // 2-B サブリーダー
  {
    ...
    revealedHobbies: new Set<HobbyTopic>(),
    support: { conservative: 25, progressive: 50, sports: 25 },
    attributes: ['fashionable', 'blonde', 'energetic_social'] as Attribute[],
    likedAttributes: ['fashionable', 'cool'] as Attribute[],
    dislikedAttributes: ['serious', 'introverted'] as Attribute[],
  ...
  // 2-B メンバー
  {
    ...
    hairStyle: 'straight' as HairStyle,
    personality: 'passionate' as Personality,
    hobbies: makeHobbies(['sports', 'video'], ['reading']),
    revealedHobbies: new Set<HobbyTopic>(),
    support: { conservative: 20, progressive: 20, sports: 60 },
    attributes: ['sporty', 'energetic'] as Attribute[],
    likedAttributes: ['sporty', 'energetic'] as Attribute[],
    dislikedAttributes: ['fashionable', 'cool'] as Attribute[],
  ...
  // 2-C サブリーダー
  {
    ...
    hairStyle: 'braid' as HairStyle,
    personality: 'stubborn' as Personality,
    hobbies: makeHobbies(['music', 'reading'], ['game', 'sports']),
    revealedHobbies: new Set<HobbyTopic>(),
    support: { conservative: 50, progressive: 30, sports: 20 },
    attributes: ['cool', 'serious'] as Attribute[],
    likedAttributes: ['cool', 'serious', 'fashionable'] as Attribute[],
    dislikedAttributes: ['airhead', 'energetic_social'] as Attribute[],
  ...
  // 2-C メンバー
  {
    ...
    hairStyle: 'bun' as HairStyle,
    personality: 'flexible' as Personality,
    hobbies: makeHobbies(['love', 'fortune', 'video'], ['sports']),
    revealedHobbies: new Set<HobbyTopic>(),
    support: { conservative: 40, progressive: 35, sports: 25 },
    attributes: ['airhead', 'young', 'energetic_social'] as Attribute[],
    likedAttributes: ['energetic_social', 'airhead'] as Attribute[],
    dislikedAttributes: ['cool', 'delinquent'] as Attribute[],
  ...
  // 2-D サブリーダー
  {
    ...
    hairStyle: 'straight' as HairStyle,
    personality: 'passionate' as Personality,
    hobbies: makeHobbies(['sports', 'music'], ['reading']),
    revealedHobbies: new Set<HobbyTopic>(),
  ...
  // 2-D メンバー
  {
    ...
    hairStyle: 'bob' as HairStyle,
    personality: 'stubborn' as Personality,
    hobbies: makeHobbies(['music', 'video'], ['love', 'sports']),
    revealedHobbies: new Set<HobbyTopic>(),
    support: { conservative: 30, progressive: 45, sports: 25 },
    attributes: ['cool', 'introverted'] as Attribute[],
    likedAttributes: ['cool', 'introverted'] as Attribute[],
    dislikedAttributes: ['energetic_social', 'sporty'] as Attribute[],
  ...
  // 3-A メンバー
  {
    ...
    revealedHobbies: new Set<HobbyTopic>(),
    support: { conservative: 60, progressive: 25, sports: 15 },
    attributes: ['serious', 'glasses', 'adult'] as Attribute[],
    likedAttributes: ['serious', 'adult'] as Attribute[],
    dislikedAttributes: ['airhead', 'delinquent'] as Attribute[],
  ...
  // 3-B サブリーダー
  {
    ...
    hairStyle: 'straight' as HairStyle,
    personality: 'passionate' as Personality,
    hobbies: makeHobbies(['sns', 'reading'], ['sports']),
    revealedHobbies: new Set<HobbyTopic>(),
    support: { conservative: 15, progressive: 60, sports: 25 },
    attributes: ['energetic', 'serious'] as Attribute[],
    likedAttributes: ['serious', 'energetic'] as Attribute[],
    dislikedAttributes: ['airhead', 'sporty'] as Attribute[],
  ...
  // 3-B メンバー
  {
    ...
    hairStyle: 'ponytail' as HairStyle,
    personality: 'flexible' as Personality,
    hobbies: makeHobbies(['sports', 'love'], ['study']),
    revealedHobbies: new Set<HobbyTopic>(),
    support: { conservative: 35, progressive: 30, sports: 35 },
    attributes: ['sporty', 'energetic_social'] as Attribute[],
    likedAttributes: ['sporty', 'energetic_social'] as Attribute[],
    dislikedAttributes: ['introverted', 'cool'] as Attribute[],
  ...
  // 3-C メンバー
  {
    ...
    hairStyle: 'straight' as HairStyle,
    personality: 'stubborn' as Personality,
    hobbies: makeHobbies(['sports'], ['study', 'reading']),
    revealedHobbies: new Set<HobbyTopic>(),
  ...
  // 3-D メンバー
  {
    ...
    hairStyle: 'straight' as HairStyle,
    personality: 'passionate' as Personality,
    hobbies: makeHobbies(['game', 'sports'], ['study', 'reading']),
    revealedHobbies: new Set<HobbyTopic>(),
    support: { conservative: 10, progressive: 15, sports: 75 },
    attributes: ['delinquent', 'energetic', 'adult'] as Attribute[],
    likedAttributes: ['sporty', 'energetic', 'delinquent'] as Attribute[],
    dislikedAttributes: ['serious', 'glasses'] as Attribute[],
